...
fileprivate struct AssociatedInstance {
    ...
    fileprivate var animations: [MagiMotionAnimation]?
    
    /// An optional reference to the motion animation modifiers.
    fileprivate var modifiers: [MagiMotionModifier]?
    ...
    fileprivate var associatedInstance: AssociatedInstance {
        get {
            return AssociatedObject.get(base: self, key: &AssociatedInstanceKey){
                return AssociatedInstance(isEnabled: true,
                                          isEnabledForSubviews: true,
                                          identifier: nil,
                                          animations: nil,
                                          modifiers: nil,
                                          alpha: nil)
        ...
        set(value) {
            AssociatedObject.set(base: self,
                                 key: &AssociatedInstanceKey,
                                 value: value)
        }
    }
}
...
public extension UIView {
     ...
     */
    func transition(_ modifiers: MagiMotionModifier...) {
...
internal extension UIView {
    ...
    var motionModifiers: [MagiMotionModifier]? {
        get {
...
internal extension UIView {
    ...
    /**
     ...
     - Returns: A TimeInterval.
     */
    func optimizedDuration(targetState: MagiMotionTargetState) -> TimeInterval {
